...
extension StocksController
{
    ...
    func initCollectionView()
    {
        ...
        refresher.addTarget(self, action: #selector(self.updateCompany), for: .valueChanged)
        ...
        self.collectionView.startShimmerAnimation(withIdentifier: "companyCell")
